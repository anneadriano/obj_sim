'''
Does the same as calculate_magnitudes.py, except adds the distance correction for both the reference and target objects
'''
...
if __name__ == "__main__":
    ...
    for file in files:  
        ...
        I_ref = -2.5*np.log10(B_ref/t_exp*((d_target_km/d_ref)/scale)**2)
